...
systems. The Pillow library provides much faster conversion between
color systems.
...
returns neither resolution nor color depth.
...
206 considers the module as *designed poorly and […] now near-impossible
to fix*.
